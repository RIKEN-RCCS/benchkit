...
| `GET /results/detail/<filename>/reuse-packet.md` | no by default | conditional | conditional | yes | no | Markdown reuse packet. Keep on restricted/console surfaces until a public release review and usefulness examples are defined. |
| `GET /results/detail/<filename>/reuse-manifest.json` | no by default | conditional | conditional | yes | no | Machine-readable reuse manifest. Keep on restricted/console surfaces until a public release review and usefulness examples are defined. |
