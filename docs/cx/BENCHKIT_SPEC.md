...
Portal の Evidence Snapshot では、latest result の packet status と、既に利用可能な latest public reuse packet を分けて表示してよい。これにより、最新 result が追加の public input binding を待っている場合でも、過去の eligible result から reuse packet を取得できる。
...
In the Portal Evidence Snapshot, the latest result packet status may be shown separately from the latest available public reuse packet. This keeps older eligible packets discoverable even when the newest result still needs public input binding.
...
- [ESTIMATION_SPEC.md](./ESTIMATION_SPEC.md)
- [ESTIMATE_JSON_SPEC.md](./ESTIMATE_JSON_SPEC.md)
- [ESTIMATION_INPUT_ACQUISITION_SPEC.md](./ESTIMATION_INPUT_ACQUISITION_SPEC.md)
- [ESTIMATION_PACKAGE_SPEC.md](./ESTIMATION_PACKAGE_SPEC.md)
- [ESTIMATION_PACKAGE_METADATA_SPEC.md](./ESTIMATION_PACKAGE_METADATA_SPEC.md)
- [ESTIMATION_PACKAGE_SHELL_API_SPEC.md](./ESTIMATION_PACKAGE_SHELL_API_SPEC.md)
- [REESTIMATION_SPEC.md](./REESTIMATION_SPEC.md)
- [RESULT_STORAGE_DESIGN.md](./RESULT_STORAGE_DESIGN.md)
- [AUDIT_LOG_SPEC.md](./AUDIT_LOG_SPEC.md)
