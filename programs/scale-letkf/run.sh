...
case "$system" in
	...
	case "$nodes" in
	    3)
    SCALE_DATABASE="/vol0003/rccs-sdt/data/a01011/tgz-archive/scale_database.tar.gz"
    SCALE_TESTDATA="/vol0003/rccs-sdt/data/a01011/tgz-archive/SCALE-LETKF.dataset-SC23.part1.20240410.tar.gz"
